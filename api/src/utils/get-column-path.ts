import type { Relation, SchemaOverview } from '@cairncms/types';
...
/**
 * Converts a CairnCMS field list path to the correct SQL names based on the constructed alias map.
