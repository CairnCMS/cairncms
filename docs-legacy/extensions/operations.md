...
loading your operation, this object is imported by the CairnCMS App host.
...
your operation, this object is imported by the CairnCMS API host.
...
The extension id needs to be identical for both entrypoints in order for CairnCMS to recognize them as part of the same
extension.
