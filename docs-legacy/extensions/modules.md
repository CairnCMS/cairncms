---
description: A guide on how to build custom Modules in CairnCMS.
readTime: 5 min read
---

# Custom Modules <small></small>

> Custom Modules are completely open-ended components that allow you to create new experiences within the CairnCMS
...
`private-view` component to get access to CairnCMS' page structure consisting of the module bar, the navigation, the
...
The CairnCMS App's Vue app instance provides a field called `api`, which can be injected into Vue components using
