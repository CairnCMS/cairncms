---
description: A guide on how to build extension bundles in CairnCMS.
readTime: 5 min read
---
...
When [scaffolding your CairnCMS extension](/extensions/creating-extensions.html#scaffolding-your-cairncms-extension),
select the `bundle` type. This will create a new empty bundle.

## Entries

In your bundle's `package.json` file, the `cairncms:extension` object has an `entries` array that describes all of the
