# @cairncms/storage-driver-azure

Internal package. Azure Blob Storage driver for the CairnCMS storage layer.
...
For CairnCMS itself, see the [main repository](https://github.com/CairnCMS/cairncms) and [documentation](https://cairncms.dev/docs).
