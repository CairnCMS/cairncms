...
- **[Config as code](/docs/manage/config-as-code/)** — the same diff/apply pattern for roles, permissions, folders, project settings, extension settings, and translations.
