---
description: An introduction to custom Extensions in CairnCMS.
readTime: 2 min read
---

# Extensions

> In addition to being highly customizable, CairnCMS has been architected to be completely modular and extensible. This
> ensures you will never hit a hard feature ceiling within the platform.

Build, modify or expand any feature needed for your app or project. What makes CairnCMS so flexible is that it has been
...
Allow creating custom experiences within the CairnCMS App.
