---
description: A guide on how to build custom Themes in CairnCMS.
readTime: 2 min read
---

# Themes & Styling

> **Form Follows Function** is the guiding design principle of CairnCMS. The minimal UI allows the platform to be easily
> tailored to your brand. [Learn more about the App](/app/overview).

## App Themes

The CairnCMS App has been developed with customization and extensibility in mind. Colors and styles referenced within
...
- **Themes** — See the [Light Theme](https://github.com/CairnCMS/cairncms/blob/main/app/src/styles/themes/_light.scss)
  or [Dark Theme](https://github.com/CairnCMS/cairncms/blob/main/app/src/styles/themes/_dark.scss)
- **Typography** — See the [Fonts](https://github.com/CairnCMS/cairncms/blob/main/app/src/styles/_type-styles.scss) and
  [Type Styles](https://github.com/CairnCMS/cairncms/blob/main/app/src/styles/mixins/type-styles.scss)
- **Variables** — See the
  [Global Variables](https://github.com/CairnCMS/cairncms/blob/main/app/src/styles/_variables.scss)
...
"CairnCMS Purple". While it may be tempting to override this variable with your brand's color, please first review the
following warnings:
