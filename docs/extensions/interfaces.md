---
description: A guide on how to build custom Interfaces in CairnCMS.
readTime: 4 min read
---
...
is imported by the CairnCMS host.
...
The interface component is the part of your extension that will be rendered by the CairnCMS App whenever your interface
...
component, it should be emitted to the CairnCMS App by using the `input` emit.
...
Other than this simple API to communicate with the CairnCMS App, the interface component is a blank canvas, allowing you
