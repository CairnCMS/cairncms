		...
		.v-list.nav {
			#{$this}:not(.dense) {
				...
				--v-list-item-background-color-active: var(
					--v-list-item-background-color-active-nav,
					var(--background-normal-alt)
				);
				--v-list-item-background-color-hover: var(
					--v-list-item-background-color-hover-nav,
					var(--background-normal-alt)
				);
